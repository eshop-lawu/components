...
public class TransactionTest extends EmbeddedRedis {
    ...
    public void sendNotice() throws InterruptedException {
        ...
        followTransactionRecordDOExample.createCriteria().andTransationIdEqualTo(transactionRecordDO.getId()).andTopicEqualTo(testTransactionMainServiceImpl.getTopic());
